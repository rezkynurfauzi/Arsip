                ...
                <div class="row" style="margin-bottom:5px;">
                    ...
                    <div class="col-md-3">
                        <div class="sm-st clearfix">
                            ...
                            <div class="sm-st-info">
                                <?php $tampil = mysqli_query($conn, "select * from data_dokumen order by id desc");
                            ...
                            <div class="panel-body" id="noti-box">
                                ...
                                ?>
                                    <div class="alert alert-block alert-danger">
                                        ...
                                        <strong><?php echo $data2['nama']; ?></strong>, Telah terdaftar menjadi anggota Arsip Buku.
                                    </div>
                                <?php } ?>
                                ...
                                ?>
                                    <div class="alert alert-success">
                                        ...
                                        <strong><?php echo $data3['fullname']; ?></strong>, Telah ditambahkan menjadi admin Arsip Buku yang baru.
                                    </div>
                                <?php } ?>

                                <?php
                                $tampil = mysqli_query($conn, "select * from data_dokumen order by id desc limit 1");
                                ...
                                ?>
                                    <div class="alert alert-info">
                                        ...
                                        <strong><?php echo $data4['judul']; ?></strong>, Dokumen bacaan baru yang ada di Arsip Buku.
                                    </div>
                                <?php } ?>
                                ...
                                ?>
                                    <div class="alert alert-warning">
                                        ...
                                        <strong><?php echo $data5['nama']; ?> </strong> Pengunjung baru di Arsip Buku.
                                    </div>
                                <?php } ?>
                            </div>
                        </section>
                        ...
                        <section class="panel tasks-widget">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="task-content">
                                    ...
                                    <ul class="task-list">
                                        <?php
                                        $tampil = mysqli_query($conn, "select * from data_dokumen order by id desc limit 5");
