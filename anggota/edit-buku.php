                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="panel">
                            ...
                            <?php
                            $query = mysqli_query($conn, "SELECT * FROM data_dokumen WHERE id='$_GET[kd]'");
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal style-form" style="margin-top: 20px;" action="update-buku.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <select class="form-control" name="kategori" id="kategori" required="">
                                                <option value=""></option>
                                                <option value="Biasa" <?php if($data['kategori'] == "Biasa") echo 'selected'?>> Biasa</option>
                                                <option value="Penting" <?php if($data['kategori'] == "Penting") echo 'selected'?>> Penting</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="asal" type="text" id="asal" class="form-control" autocomplete="off" value="<?php echo $data['asal']; ?>" required="" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">Dokumen</label>
                                        <div class="col-sm-8">
                                            <span class="help-block">Silahkan memilih Dokumen untuk update atau mengedit data, tekan tombol batal untuk kembali.</span>
