...
<head>
    <meta charset="UTF-8">
    <title>Arsip Buku || Menyimpan Data Lebih!</title>
    ...
    <meta name="Arsip Buku" content="Arsip Buku" />
    <!-- bootstrap 3.0.2 -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info alert-dismissable">
                            ...
                            <b>Selamat Datang di Arsip Buku, Untuk Login silahkan klik Icon User atau klik <a href="login.html">disini</a></b>
                        </div>
                    </div>
                                ...
                                <div class="twt-area">
                                    <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-pengunjung.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input name="keperluan" type="text" id="keperluan" class="form-control" placeholder="Keperluan" required />
                                                <!--<span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span>-->
                                            </div>
                                        </div>
                                        <div class="form-group">
                            ...
                            <?php while ($data1 = mysqli_fetch_array($tampil)) { ?>
                                <tbody>
                                    <tr>
                                        ...
                                        <td><?php echo $data1['keperluan']; ?></td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">ArsipBuku</h4>
                </div>
                <div class="modal-body">
                    <p> Arsip Buku adalah salah satu layanan bagi pengguna untuk menyimpan data - data buku dengan mudah.</p>
                    <p> Arsip Buku bebasis website yang responsif, untuk info, saran, maupun kritik bisa menghubungi kami :</p>
                    <table>
                        <tr>
                            <td>E-mail</td>
                            <td>:</td>
                            <td><a href="arsibuku@gmail">ArsipBuku@gmail.com</a></td>
                        </tr>
                        <br />
                        <tr>
                            <td>Blog</td>
